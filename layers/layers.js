...
var format_GREENLSOA28ASmethwick_4 = new ol.format.GeoJSON();
var features_GREENLSOA28ASmethwick_4 = format_GREENLSOA28ASmethwick_4.readFeatures(json_GREENLSOA28ASmethwick_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_GREENLSOA28ASmethwick_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_GREENLSOA28ASmethwick_4.addFeatures(features_GREENLSOA28ASmethwick_4);
var lyr_GREENLSOA28ASmethwick_4 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_GREENLSOA28ASmethwick_4, 
                style: style_GREENLSOA28ASmethwick_4,
                popuplayertitle: 'GREEN LSOA 28A Smethwick',
                interactive: true,
    title: 'GREEN LSOA 28A Smethwick<br />\
    <img src="styles/legend/GREENLSOA28ASmethwick_4_0.png" /> Amenity - Residential Or Business<br />\
    <img src="styles/legend/GREENLSOA28ASmethwick_4_1.png" /> Amenity - Transport<br />\
    <img src="styles/legend/GREENLSOA28ASmethwick_4_2.png" /> Institutional Grounds<br />\
    <img src="styles/legend/GREENLSOA28ASmethwick_4_3.png" /> Other Sports Facility<br />\
    <img src="styles/legend/GREENLSOA28ASmethwick_4_4.png" /> Private Garden<br />\
    <img src="styles/legend/GREENLSOA28ASmethwick_4_5.png" /> Public Park Or Garden<br />\
    <img src="styles/legend/GREENLSOA28ASmethwick_4_6.png" /> Religious Grounds<br />\
    <img src="styles/legend/GREENLSOA28ASmethwick_4_7.png" /> School Grounds<br />' });
var format_BUSLSOA28ASmethwick_5 = new ol.format.GeoJSON();
var features_BUSLSOA28ASmethwick_5 = format_BUSLSOA28ASmethwick_5.readFeatures(json_BUSLSOA28ASmethwick_5, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_BUSLSOA28ASmethwick_5 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_BUSLSOA28ASmethwick_5.addFeatures(features_BUSLSOA28ASmethwick_5);
var lyr_BUSLSOA28ASmethwick_5 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_BUSLSOA28ASmethwick_5, 
                style: style_BUSLSOA28ASmethwick_5,
                popuplayertitle: 'BUS LSOA 28A Smethwick',
                interactive: true,
                title: '<img src="styles/legend/BUSLSOA28ASmethwick_5.png" /> BUS LSOA 28A Smethwick'
            });
var format_SmethwickBdgs_6 = new ol.format.GeoJSON();
var features_SmethwickBdgs_6 = format_SmethwickBdgs_6.readFeatures(json_SmethwickBdgs_6, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_SmethwickBdgs_6 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_SmethwickBdgs_6.addFeatures(features_SmethwickBdgs_6);
var lyr_SmethwickBdgs_6 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_SmethwickBdgs_6, 
                style: style_SmethwickBdgs_6,
                popuplayertitle: 'Smethwick Bdgs',
                interactive: true,
                title: '<img src="styles/legend/SmethwickBdgs_6.png" /> Smethwick Bdgs'
            });
var format_SmethwickTown_7 = new ol.format.GeoJSON();
var features_SmethwickTown_7 = format_SmethwickTown_7.readFeatures(json_SmethwickTown_7, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_SmethwickTown_7 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_SmethwickTown_7.addFeatures(features_SmethwickTown_7);
var lyr_SmethwickTown_7 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_SmethwickTown_7, 
                style: style_SmethwickTown_7,
                popuplayertitle: 'Smethwick Town',
                interactive: true,
                title: '<img src="styles/legend/SmethwickTown_7.png" /> Smethwick Town'
            });
var format_LSOA28AFlyTipping2025_8 = new ol.format.GeoJSON();
var features_LSOA28AFlyTipping2025_8 = format_LSOA28AFlyTipping2025_8.readFeatures(json_LSOA28AFlyTipping2025_8, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_LSOA28AFlyTipping2025_8 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_LSOA28AFlyTipping2025_8.addFeatures(features_LSOA28AFlyTipping2025_8);
var lyr_LSOA28AFlyTipping2025_8 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_LSOA28AFlyTipping2025_8, 
                style: style_LSOA28AFlyTipping2025_8,
                popuplayertitle: 'LSOA 28A Fly Tipping  2025',
                interactive: true,
                title: '<img src="styles/legend/LSOA28AFlyTipping2025_8.png" /> LSOA 28A Fly Tipping  2025'
            });
var format_LSOA28ADogMess2025_9 = new ol.format.GeoJSON();
var features_LSOA28ADogMess2025_9 = format_LSOA28ADogMess2025_9.readFeatures(json_LSOA28ADogMess2025_9, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_LSOA28ADogMess2025_9 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_LSOA28ADogMess2025_9.addFeatures(features_LSOA28ADogMess2025_9);
var lyr_LSOA28ADogMess2025_9 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_LSOA28ADogMess2025_9, 
                style: style_LSOA28ADogMess2025_9,
                popuplayertitle: 'LSOA 28A Dog Mess 2025',
                interactive: true,
                title: '<img src="styles/legend/LSOA28ADogMess2025_9.png" /> LSOA 28A Dog Mess 2025'
            });
var format_SmethwickRoads_10 = new ol.format.GeoJSON();
var features_SmethwickRoads_10 = format_SmethwickRoads_10.readFeatures(json_SmethwickRoads_10, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_SmethwickRoads_10 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_SmethwickRoads_10.addFeatures(features_SmethwickRoads_10);
var lyr_SmethwickRoads_10 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_SmethwickRoads_10, 
                style: style_SmethwickRoads_10,
                popuplayertitle: 'Smethwick Roads',
                interactive: true,
                title: '<img src="styles/legend/SmethwickRoads_10.png" /> Smethwick Roads'
            });
var format_LLPGLSOA28ASmethwick_11 = new ol.format.GeoJSON();
var features_LLPGLSOA28ASmethwick_11 = format_LLPGLSOA28ASmethwick_11.readFeatures(json_LLPGLSOA28ASmethwick_11, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_LLPGLSOA28ASmethwick_11 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_LLPGLSOA28ASmethwick_11.addFeatures(features_LLPGLSOA28ASmethwick_11);
var lyr_LLPGLSOA28ASmethwick_11 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_LLPGLSOA28ASmethwick_11, 
                style: style_LLPGLSOA28ASmethwick_11,
                popuplayertitle: 'LLPG LSOA 28A Smethwick',
                interactive: true,
    title: 'LLPG LSOA 28A Smethwick<br />\
    <img src="styles/legend/LLPGLSOA28ASmethwick_11_0.png" /> Sandwell MBC<br />\
    <img src="styles/legend/LLPGLSOA28ASmethwick_11_1.png" /> <br />\
    <img src="styles/legend/LLPGLSOA28ASmethwick_11_2.png" /> Non Sandwell MBC<br />' });
var format_BoundayLinesLSOA28A_12 = new ol.format.GeoJSON();
var features_BoundayLinesLSOA28A_12 = format_BoundayLinesLSOA28A_12.readFeatures(json_BoundayLinesLSOA28A_12, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_BoundayLinesLSOA28A_12 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_BoundayLinesLSOA28A_12.addFeatures(features_BoundayLinesLSOA28A_12);
var lyr_BoundayLinesLSOA28A_12 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_BoundayLinesLSOA28A_12, 
                style: style_BoundayLinesLSOA28A_12,
                popuplayertitle: 'Bounday Lines LSOA 28A ',
                interactive: true,
                title: '<img src="styles/legend/BoundayLinesLSOA28A_12.png" /> Bounday Lines LSOA 28A '
            });
var format_LSOA28AFlyPostingGraffitti_13 = new ol.format.GeoJSON();
var features_LSOA28AFlyPostingGraffitti_13 = format_LSOA28AFlyPostingGraffitti_13.readFeatures(json_LSOA28AFlyPostingGraffitti_13, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_LSOA28AFlyPostingGraffitti_13 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_LSOA28AFlyPostingGraffitti_13.addFeatures(features_LSOA28AFlyPostingGraffitti_13);
var lyr_LSOA28AFlyPostingGraffitti_13 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_LSOA28AFlyPostingGraffitti_13, 
                style: style_LSOA28AFlyPostingGraffitti_13,
                popuplayertitle: 'LSOA 28A Fly Posting Graffitti',
                interactive: true,
                title: '<img src="styles/legend/LSOA28AFlyPostingGraffitti_13.png" /> LSOA 28A Fly Posting Graffitti'
            });
var format_LSOA28ADangerousLitter_14 = new ol.format.GeoJSON();
var features_LSOA28ADangerousLitter_14 = format_LSOA28ADangerousLitter_14.readFeatures(json_LSOA28ADangerousLitter_14, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_LSOA28ADangerousLitter_14 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_LSOA28ADangerousLitter_14.addFeatures(features_LSOA28ADangerousLitter_14);
var lyr_LSOA28ADangerousLitter_14 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_LSOA28ADangerousLitter_14, 
                style: style_LSOA28ADangerousLitter_14,
                popuplayertitle: 'LSOA 28A Dangerous Litter',
                interactive: true,
                title: '<img src="styles/legend/LSOA28ADangerousLitter_14.png" /> LSOA 28A Dangerous Litter'
            });

lyr_SmethwickCanals_0.setVisible(true);lyr_LSOA28ASmethwick_1.setVisible(true);lyr_SmethwickMetro_2.setVisible(true);lyr_RailSmethwickTown_3.setVisible(true);lyr_GREENLSOA28ASmethwick_4.setVisible(true);lyr_BUSLSOA28ASmethwick_5.setVisible(true);lyr_SmethwickBdgs_6.setVisible(true);lyr_SmethwickTown_7.setVisible(true);lyr_LSOA28AFlyTipping2025_8.setVisible(true);lyr_LSOA28ADogMess2025_9.setVisible(true);lyr_SmethwickRoads_10.setVisible(true);lyr_LLPGLSOA28ASmethwick_11.setVisible(true);lyr_BoundayLinesLSOA28A_12.setVisible(true);lyr_LSOA28AFlyPostingGraffitti_13.setVisible(true);lyr_LSOA28ADangerousLitter_14.setVisible(true);
var layersList = [lyr_SmethwickCanals_0,lyr_LSOA28ASmethwick_1,lyr_SmethwickMetro_2,lyr_RailSmethwickTown_3,lyr_GREENLSOA28ASmethwick_4,lyr_BUSLSOA28ASmethwick_5,lyr_SmethwickBdgs_6,lyr_SmethwickTown_7,lyr_LSOA28AFlyTipping2025_8,lyr_LSOA28ADogMess2025_9,lyr_SmethwickRoads_10,lyr_LLPGLSOA28ASmethwick_11,lyr_BoundayLinesLSOA28A_12,lyr_LSOA28AFlyPostingGraffitti_13,lyr_LSOA28ADangerousLitter_14];
...
lyr_GREENLSOA28ASmethwick_4.set('fieldAliases', {'toid': 'toid', 'version': 'version', 'priFunc': 'priFunc', 'secFunc': 'secFunc', 'priForm': 'priForm', 'secForm': 'secForm', });
lyr_BUSLSOA28ASmethwick_5.set('fieldAliases', {'indicator': 'indicator', 'suburblang': 'suburblang', 'notes': 'notes', 'mod': 'mod', 'gridtype': 'gridtype', 'moddatetim': 'moddatetim', 'naptancode': 'naptancode', 'gparentln': 'gparentln', 'latitude': 'latitude', 'creatdatet': 'creatdatet', 'revnum': 'revnum', 'northing': 'northing', 'shortcn': 'shortcn', 'lname': 'lname', 'noteslang': 'noteslang', 'atcocode': 'atcocode', 'commonname': 'commonname', 'lcentre': 'lcentre', 'street': 'street', 'adminareac': 'adminareac', 'indlang': 'indlang', 'landmark': 'landmark', 'platecode': 'platecode', 'longitude': 'longitude', 'cleardwnco': 'cleardwnco', 'easting': 'easting', 'timingstat': 'timingstat', 'town': 'town', 'nptglcode': 'nptglcode', 'bearing': 'bearing', 'parentln': 'parentln', 'cnlang': 'cnlang', 'dfltwaitti': 'dfltwaitti', 'crossing': 'crossing', 'townlang': 'townlang', 'shcnlang': 'shcnlang', 'busstoptyp': 'busstoptyp', 'stoptype': 'stoptype', 'suburb': 'suburb', 'streetlang': 'streetlang', 'crosslang': 'crosslang', 'lmarklang': 'lmarklang', 'objectid': 'objectid', 'status': 'status', });
lyr_SmethwickBdgs_6.set('fieldAliases', {'full_id': 'full_id', 'osm_id': 'osm_id', 'osm_type': 'osm_type', 'building': 'building', 'name': 'name', 'amenity': 'amenity', 'brand': 'brand', 'wheelchair': 'wheelchair', });
lyr_SmethwickTown_7.set('fieldAliases', {'ID': 'ID', 'Town': 'Town', });
lyr_LSOA28AFlyTipping2025_8.set('fieldAliases', {'ProcessName': 'ProcessName', 'lng': 'lng', 'lat': 'lat', 'Sum of Count': 'Sum of Count', });
lyr_LSOA28ADogMess2025_9.set('fieldAliases', {'ProcessName': 'ProcessName', 'lng': 'lng', 'lat': 'lat', 'Sum of Count': 'Sum of Count', });
lyr_SmethwickRoads_10.set('fieldAliases', {'full_id': 'full_id', 'osm_id': 'osm_id', 'osm_type': 'osm_type', 'highway': 'highway', 'name': 'name', 'surface': 'surface', 'maxspeed': 'maxspeed', 'ref': 'ref', });
lyr_LLPGLSOA28ASmethwick_11.set('fieldAliases', {'UPRN': 'UPRN', 'ADDRESS': 'ADDRESS', 'STREET_NAME': 'STREET_NAME', 'TOWN_NAME': 'TOWN_NAME', 'POSTCODE': 'POSTCODE', 'BLPU_CLASS': 'BLPU_CLASS', 'MAP_EAST': 'MAP_EAST', 'MAP_NORTH': 'MAP_NORTH', 'OWNERSHIP_uprn': 'OWNERSHIP_uprn', 'OWNERSHIP_Place-Type': 'OWNERSHIP_Place-Type', 'OWNERSHIP_Ward-Code': 'OWNERSHIP_Ward-Code', 'OWNERSHIP_Ward-Name': 'OWNERSHIP_Ward-Name', 'OWNERSHIP_ConstructionTypeName': 'OWNERSHIP_ConstructionTypeName', 'OWNERSHIP_MRA': 'OWNERSHIP_MRA', });
lyr_BoundayLinesLSOA28A_12.set('fieldAliases', {'Legend': 'Legend', 'RuleNumber': 'RuleNumber', 'FID': 'FID', 'TOID': 'TOID', 'Version': 'Version', 'VersionDat': 'VersionDat', 'Theme': 'Theme', 'Descriptiv': 'Descriptiv', 'Descript_1': 'Descript_1', 'Make': 'Make', 'PhysicalPr': 'PhysicalPr', 'FeatureCod': 'FeatureCod', 'PhysicalLe': 'PhysicalLe', 'AccuracyOf': 'AccuracyOf', 'NonBoundin': 'NonBoundin', 'LatestChan': 'LatestChan', 'LatestReas': 'LatestReas', 'ProcessDat': 'ProcessDat', 'ChunkOrigi': 'ChunkOrigi', });
lyr_LSOA28AFlyPostingGraffitti_13.set('fieldAliases', {'ProcessName': 'ProcessName', 'lng': 'lng', 'lat': 'lat', 'Sum of Count': 'Sum of Count', });
lyr_LSOA28ADangerousLitter_14.set('fieldAliases', {'ProcessName': 'ProcessName', 'lng': 'lng', 'lat': 'lat', 'Sum of Count': 'Sum of Count', });
...
lyr_GREENLSOA28ASmethwick_4.set('fieldLabels', {'toid': 'no label', 'version': 'no label', 'priFunc': 'no label', 'secFunc': 'no label', 'priForm': 'no label', 'secForm': 'no label', });
lyr_BUSLSOA28ASmethwick_5.set('fieldLabels', {'indicator': 'no label', 'suburblang': 'no label', 'notes': 'no label', 'mod': 'no label', 'gridtype': 'no label', 'moddatetim': 'no label', 'naptancode': 'no label', 'gparentln': 'no label', 'latitude': 'no label', 'creatdatet': 'no label', 'revnum': 'no label', 'northing': 'no label', 'shortcn': 'no label', 'lname': 'no label', 'noteslang': 'no label', 'atcocode': 'no label', 'commonname': 'no label', 'lcentre': 'no label', 'street': 'no label', 'adminareac': 'no label', 'indlang': 'no label', 'landmark': 'no label', 'platecode': 'no label', 'longitude': 'no label', 'cleardwnco': 'no label', 'easting': 'no label', 'timingstat': 'no label', 'town': 'no label', 'nptglcode': 'no label', 'bearing': 'no label', 'parentln': 'no label', 'cnlang': 'no label', 'dfltwaitti': 'no label', 'crossing': 'no label', 'townlang': 'no label', 'shcnlang': 'no label', 'busstoptyp': 'no label', 'stoptype': 'no label', 'suburb': 'no label', 'streetlang': 'no label', 'crosslang': 'no label', 'lmarklang': 'no label', 'objectid': 'no label', 'status': 'no label', });
lyr_SmethwickBdgs_6.set('fieldLabels', {'full_id': 'no label', 'osm_id': 'no label', 'osm_type': 'no label', 'building': 'no label', 'name': 'no label', 'amenity': 'no label', 'brand': 'no label', 'wheelchair': 'no label', });
lyr_SmethwickTown_7.set('fieldLabels', {'ID': 'no label', 'Town': 'no label', });
lyr_LSOA28AFlyTipping2025_8.set('fieldLabels', {'ProcessName': 'no label', 'lng': 'no label', 'lat': 'no label', 'Sum of Count': 'no label', });
lyr_LSOA28ADogMess2025_9.set('fieldLabels', {'ProcessName': 'no label', 'lng': 'no label', 'lat': 'no label', 'Sum of Count': 'no label', });
lyr_SmethwickRoads_10.set('fieldLabels', {'full_id': 'no label', 'osm_id': 'no label', 'osm_type': 'no label', 'highway': 'no label', 'name': 'no label', 'surface': 'no label', 'maxspeed': 'no label', 'ref': 'no label', });
lyr_LLPGLSOA28ASmethwick_11.set('fieldLabels', {'UPRN': 'no label', 'ADDRESS': 'no label', 'STREET_NAME': 'no label', 'TOWN_NAME': 'no label', 'POSTCODE': 'no label', 'BLPU_CLASS': 'no label', 'MAP_EAST': 'no label', 'MAP_NORTH': 'no label', 'OWNERSHIP_uprn': 'no label', 'OWNERSHIP_Place-Type': 'no label', 'OWNERSHIP_Ward-Code': 'no label', 'OWNERSHIP_Ward-Name': 'no label', 'OWNERSHIP_ConstructionTypeName': 'no label', 'OWNERSHIP_MRA': 'no label', });
lyr_BoundayLinesLSOA28A_12.set('fieldLabels', {'Legend': 'no label', 'RuleNumber': 'no label', 'FID': 'no label', 'TOID': 'no label', 'Version': 'no label', 'VersionDat': 'no label', 'Theme': 'no label', 'Descriptiv': 'no label', 'Descript_1': 'no label', 'Make': 'no label', 'PhysicalPr': 'no label', 'FeatureCod': 'no label', 'PhysicalLe': 'no label', 'AccuracyOf': 'no label', 'NonBoundin': 'no label', 'LatestChan': 'no label', 'LatestReas': 'no label', 'ProcessDat': 'no label', 'ChunkOrigi': 'no label', });
lyr_LSOA28AFlyPostingGraffitti_13.set('fieldLabels', {'ProcessName': 'no label', 'lng': 'no label', 'lat': 'no label', 'Sum of Count': 'no label', });
lyr_LSOA28ADangerousLitter_14.set('fieldLabels', {'ProcessName': 'no label', 'lng': 'no label', 'lat': 'no label', 'Sum of Count': 'no label', });
lyr_LSOA28ADangerousLitter_14.on('precompose', function(evt) {
